...
function setupContent() {
  ...
  if (showDefault) {
    h4[0].innerHTML = 'Elevate your experience.<br>Not your budget.'; // - Populates main headline
    ...
    // h4[0].innerHTML = "Fly from <br><span class='city'>" + "Bozeman" + "</span><br><span class='to'>to</span> <span class='city'>" + "Boston" + "</span>";
