...
function setupContent() {
  ...
  h4[0].innerHTML = "Fly from <br><span class='city'>" + origin_longform + "</span> <span class='to'>to</span><br><span class='city'>" + destination_longform + "</span>";


  if (showDefault) {
    h4[0].innerHTML = 'Stretch your legs (not your budget) with the most legroom in coach.<span class="asterisk">&ast;</span>'; // - Populates main headline
